<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="CapacidadTanque.aspx.cs" Inherits="wa_sicove.sicoveadmin.CapacidadTanque" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 ">
            <ul class="breadcrumb">
                ...
                <li class="active">Capacidad Tanque</li>
            </ul>
        </div>
    </div>
    <div class="content">
        <div class="main-header">
            <h2>Capacidad Tanque</h2>
            <em>Catálogos</em>
        </div>
        <div class="main-content">
            <div class="col-md-8">
                ...
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-group"></i>Capacidad Tanque</h3>
                        <em>- Capacidad Tanque</em>
            ...
            <div class="col-md-4">
                <div class="widget widget-table ">
                    <div class="widget-header">
                        <h3><i class="fa fa-group"></i>Capacidad Tanque</h3>
                        <em>- Crear o modificar Capacidad Tanque</em>
                        <div class="btn-group widget-header-toolbar">
                            <a href="#" title="Focus" class="btn-borderless btn-focus" style="display: none;"><i class="fa fa-eye"></i></a>
                            <a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
                            <a href="#" title="Remove" class="btn-borderless btn-remove" style="display: none;"><i class="fa fa-times"></i></a>
                    ...
                    <div class="widget-content">
                        <div class="form-group">
                            <label class="control-label" for="txtDescripcion"><b>Capacidad: <span style="color: red;">*</span></b></label>
    ...
    <script src="../scripts/CapacidadTanque.js"></script>
</asp:Content>
