<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="IndicadoresUnidades.aspx.cs" Inherits="wa_sicove.sicoveadmin.IndicadoresUnidades" %>
...
<div class="row">
    <div class="col-md-12">
        <ul class="breadcrumb">
            ...
            <li class="active">Consulta de Indicadores</li>
        </ul>
    </div>
</div>
<div class="content">
    <div class="main-header">
        <h2>Indicadores</h2>
        <em>Consulta de Indicadores</em>
    </div>
    <div class="main-content">
        <div class="widget">
            <div class="widget-header">
                <h3>Consultar indicadores</h3>
            </div>
            <div class="widget-content">
                <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist">
                    <li class="active"><a href="#indPorunidad" role="tab" data-toggle="tab" aria-expanded="true">Indicadores por Unidad</a></li>
                    ...
                    <div class="tab-pane fade active in" id="indPorunidad">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label class="control-label" for="idTipo"><b>Filtrar por:</b></label>
                                <select class="form-control" id="idTipo">
                                    <option value="1">Empresa</option>
                                    <option value="2">Giros</option>
                                    <option value="3">Marcas y modelos</option>
                                </select>
                            </div>

                            <div class="form-group col-md-3" id="fInicialRD">
                            ...
                            <div class="form-group col-md-3" id="fFinalRD">
                                <label class="control-label" for="fInicialR"><b>Fecha Final:</b></label><br />
                                <input type="datetime-local" class="form-control" id="fFinalR" required/>
                            </div>

                            <div class="form-group col-md-3">
                                <label class="control-label" for="uniDe"><b>Mostrar:</b></label>
    ...
    <div class="main-content">
        <div class="widget widget-table">
            <div class="widget-header">
                <h3><i class="fa fa-group"></i>Indicadores</h3>
                <em>- Lista de indicadores</em>
...
<script src="../scripts/IndicadoresUnidades.js"></script>
