<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="Ciudades.aspx.cs" Inherits="wa_sicove.sicoveadmin.Ciudades" %>
...
<div class="content">
		...
		<div class="main-content">
			<div class="col-md-8">
				...
				<div class="widget widget-table">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Ciudades</h3> <em>- Lista de ciudades</em>
            ...
            <div class="col-md-4">
                <div class="widget widget-table ">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Ciudad</h3> <em>- Crear o modificar ciudad</em>
						<div class="btn-group widget-header-toolbar">
							<a href="#" title="Focus" class="btn-borderless btn-focus" style="display:none;"><i class="fa fa-eye"></i></a>
							<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
							<a href="#" title="Remove" class="btn-borderless btn-remove" style="display:none;"><i class="fa fa-times"></i></a>
...
<script type="text/javascript">
        ...
        function guardar() {
            ...
            var urlS = "Ciudades.aspx/guardar_cd";
            if (!editando) {//GUARDAR
                urlS = "Ciudades.aspx/guardar_cd";
            } else { //EDITANDO
                urlS = "Ciudades.aspx/actualizar_cd";
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.d.Result) {
                        var msj = "Se Actualizo correctamente la ciudad.";
                        if (!editando) {
                            msj = "Se Guardo correctamente la ciudad.";
                        }
                        $.gritter.add({
                            title: "Éxito",
                            text: msj,
                    ...
                    if (response.d.Result) {
                        ...
                        for (var i = 0; i < parsedTest.length; i++) {
                            ...
                            tabla_lista.row.add([
                                ...
                                '<center>'+stado+'</center>',
                                '<center><button type="button" class="btn btn-info " onclick="ver_ciudad(\'' + parsedTest[i]['id'] + '\',\'' + parsedTest[i]['ciudad'] + '\',\'' + parsedTest[i]['estado'] + '\',\'' + parsedTest[i]['id_estado'] + '\',\'' + parsedTest[i]['estatus'] + '\')"><i class="fa fa-edit"></i></button></center>'
                            ]).draw();
        ...
        function ver_ciudad(id, ciudad, estado, id_estado, estatus) {
            $("#form1")[0].reset();
            editando = true;
            id_editando = id;
            $("#NameI").val(ciudad);
            $("#selectEst").val(id_estado);
