<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="Estados.aspx.cs" Inherits="wa_sicove.sicoveadmin.Estados" %>
    ...
    <div class="content">
		...
		<div class="main-content">
			<div class="col-md-8">
				...
				<div class="widget widget-table">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Estados</h3> <em>- Lista de estados</em>
            ...
            <div class="col-md-4">
                <div class="widget widget-table ">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Estado</h3> <em>- Crear o modificar estado</em>
						<div class="btn-group widget-header-toolbar">
							<a href="#" title="Focus" class="btn-borderless btn-focus" style="display:none;"><i class="fa fa-eye"></i></a>
							<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
							<a href="#" title="Remove" class="btn-borderless btn-remove" style="display:none;"><i class="fa fa-times"></i></a>
					...
					<div class="widget-content">
                        <div class="form-group">
							...
							<input type="text" class="form-control input-mayus" id="descripcionI" required>
                        </div>
						<div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function guardar() {
            ...
            var activo = $("#activoCH").prop('checked') == true ? 1 : 0;
             var urlS = "Estados.aspx/guardar_estado";
                if (!editando) {//GUARDAR
                    urlS = "Estados.aspx/guardar_estado";
                } else { //EDITANDO
                    urlS = "Estados.aspx/actualizar_estado";
                }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.d.Result) {
                            var msj = "Se Actualizo correctamente el estado.";
                            if (!editando) {
                                msj = "Se Guardo correctamente el estado.";
                            }
                            $.gritter.add({
                                title: "Éxito",
                                text: msj,
                    ...
                    if (response.d.Result) {
                        ...
                        for (var i = 0; i < parsedTest.length; i++) {
                            ...
                            tabla_lista.row.add([
                                ...
                                '<center>'+stado+'</center>',
                                '<center><button type="button" class="btn btn-info " onclick="ver_estado(\'' + parsedTest[i]['id_rol'] + '\',\'' + parsedTest[i]['descripcion_rol'] + '\',\'' + parsedTest[i]['estatus_rol'] + '\')"><i class="fa fa-edit"></i></button></center>'
                            ]).draw();
        ...
        function ver_estado(id_rol, descripcion, estatus) {
            $("#form1")[0].reset();
            editando = true;
            id_editando = id_rol;
