<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="TiposCortesia.aspx.cs" Inherits="wa_sicove.sicoveadmin.TiposCortesia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
		<div class="col-md-12 ">
			<ul class="breadcrumb">
				...
				<li class="active">Tipos de Cortesías</li>
			</ul>
		</div>
    </div>
    <div class="content">
		<div class="main-header">
			<h2>Tipos de Cortesias</h2>
			<em>Catálogos</em>
		</div>
		<div class="main-content">
			<div class="col-md-8">
				...
				<div class="widget widget-table">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Tipos de Cortesías</h3> <em>- Listado</em>
            ...
            <div class="col-md-4">
                <div class="widget widget-table ">
					<div class="widget-header">
						<h3><i class="fa fa-group"></i> Tipo de Cortesía</h3> <em>- Crear o modificar estado</em>
						<div class="btn-group widget-header-toolbar">
							<a href="#" title="Focus" class="btn-borderless btn-focus" style="display:none;"><i class="fa fa-eye"></i></a>
							<a href="#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
							<a href="#" title="Remove" class="btn-borderless btn-remove" style="display:none;"><i class="fa fa-times"></i></a>
    ...
    <script type="text/javascript">
        ...
        function guardar() {
            ...
            var urlS = "TiposCortesia.aspx/guardar";
            if (!editando) {//GUARDAR
                urlS = "TiposCortesia.aspx/guardar";
            } else { //EDITANDO
                urlS = "TiposCortesia.aspx/actualizar";
            }
                    ...
                    if (response.d.Result) {
                        ...
                        for (var i = 0; i < parsedTest.length; i++) {
                            ...
                            tabla_lista.row.add([
                                ...
                                '<center>'+stado+'</center>',
                                '<center><button type="button" class="btn btn-info " onclick="ver_tipo(\'' +
                                parsedTest[i]['id'] + '\',\'' + parsedTest[i]['descripcion'] + '\',\'' +
                                parsedTest[i]['estatus'] + '\')"><i class="fa fa-edit"></i></button></center>'
                            ]).draw();
        ...
        function ver_tipo(id_rol, descripcion, estatus) {
            editando = true;
            id_editando = id_rol;
