<%@ Page Title="" Language="C#" MasterPageFile="~/sicoveadmin/Admin.Master" AutoEventWireup="true" CodeBehind="RegistroUnidades.aspx.cs" Inherits="wa_sicove.sicoveadmin.RegistroUnidades" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12">
                <div class="widget widget-table">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group col-md-4">
                            <label  class="control-label" for="selectLider"><b>Lider de base: <span style="color: red;">*</span></b></label>
                            <select class="form-control" id="selectLider" required>
                                
                            </select>
                        </div>
                        
                        <div class="form-group col-md-5">
                            <label class="control-label" for="selectLider"><b>Comodatario: <span style="color: red;">*</span></b></label>
                            <select class="form-control" id="selectComodatario" required>

                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label" for="selectBase"><b>Bases:</b></label>
                            <select class="form-control" id="selectBase">

                            </select>
                        </div>
                        <div class="form-group col-md-2">
                            <label for="numEconomico"><b>N&uacute;mero Econ&oacute;mico: <span style="color: red;">*</span></b></label>
                            <input class="form-control" type="text" id="numEconomico"/>
                        </div>
                        <div class="form-group col-md-2">
                            <label for="txtCodigoBarra"><b>N&uacute;mero de Contrato:<span style="color: red;">*</span></b></label>
                            <input class="form-control" type="text" id="txtCodigoBarra" required/>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="numTelefono"><b>Tel&eacute;fono: <span style="color: red;">*</span></b></label>
                            <input class="form-control input-only-number telef" type="tel" id="numTelefono" maxlength="15"/>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="txtDireccion"><b>Direcci&oacute;n: <span style="color: red;">*</span></b></label>
                        ...
                        <div class="form-group col-md-6">
                            <label class="control-label" for="selectBase"><b>Estatus instalacion: <span style="color: red;">*</span></b></label>
                            <select class="form-control" id="selecetEstInst" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" id="tMantenimiento" min="1"/>
                        </div>

                        <div class="form-group col-md-4">
                            <label  class="control-label" for="selectTiempoMtto"><b>Tiempo: <span style="color: red;">*</span></b></label>
                            <select class="form-control" id="selectTiempoMtto">
                ...
                <div class="widget widget-table">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control " type="text" id="txtPlaca"/>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="portlet-body">
                                        <div class="row" id="MuestraTanques">
                                            <div class="form-group col-md-4 col-sm-12">
                                                ...
                                                <select class="form-control marca sc2 mrk selMrkT" id="selectMT0">
                                                    
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4 col-sm-12">
                                                <label class="control-label"><b>Tipo Tanque: <span style="color: red;">*</span></b></label>
                                                <select class="form-control tipo sc2 tik" id="selectTT0">
                                                    
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4 col-sm-12">
                                                <label class="control-label"><b>Capacidad Tanque: <span style="color: red;">*</span></b></label>
                                                <select class="form-control capacidad sc2 cak" id="selectCT0">
                                                   
                                                </select>
                                            </div>
                                            <div class="form-group col-md-3 col-sm-12">
                                                <label><b>Tanque: <span style="color: red;">*</span></b></label>
                                                <input class="form-control" type="text" id="numSerieT0" placeholder="Número de serie"/>
                                            </div>
                                            <div class="form-group col-md-3 col-sm-12">
                                            ...
                                            <div class="form-group col-md-3 col-sm-12">
                                                ...
                                                <input class="form-control" type="text" id="numMV0" placeholder="Número de serie"/>
                                            </div>
    ...
    <script src="../scripts/RegistroUnidades.js"></script>
</asp:Content>