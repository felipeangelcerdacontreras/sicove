    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        public static ajaxResponse CerrarSesion(int idusuario)
        {
            ...
            sicoveDBDataContext context = new sicoveDBDataContext();
                ...
                b.bit_accion = "Logout";
                b.bit_observaciones = ((si_usuarios)HttpContext.Current.Session["sesionUsuario"]).us_nombre + "(" + ((si_usuarios)HttpContext.Current.Session["sesionUsuario"]).us_user + ") - Usuario Cierra Sesion";
        ...
        public static ajaxResponse CargaMenuPadre()
        {
            ...
            try
            {
                    ...
                    else
                    {
                        ...
                        Response.Message = "El Rol de comodatario no cuenta con modulos visibles, verifique por favor.";
                        Response.Data = null;
                    }
